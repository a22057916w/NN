...
def load_iris_data(fp):
    ...
    feature_names = data[0, 1:5].tolist()
    ...
    return features, labels, dict(enumerate(species)), feature_names


if __name__ == "__main__":
    features, labels, species_to_label, feature_names = load_iris_data('Iris.csv')

    plot_feature_scatter(features, labels, species_to_label, feature_names)
